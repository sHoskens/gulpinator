...
var config = {
  default: {
    ...
    seperateBundlesPerPage: {
      ...
      pages: [
        {
          names: [], // names of all the html pages to inject below bundles in
          styleBundles: [], // names of all stylesheets for these page
          scriptBundles: [] // names of all script bundles for these pages (including libraries!)
        }
      ]
    }
  },

  // You can overwrite the properties above for specific environments. To do
  // this, add the name of your defined object (prod in the example below) to
  // the gulp task like so:
  // gulp build --env=prod
  prod: {
    jshint: false,
    jscs: false,
      ...
      pages: [
        {
          ...
          scriptBundles: ['angularBundle', 'utilities', 'app', 'exampleTodoApp', 'exampleTodoApp-tmpl', 'bundle1']
        },
        {
          names: ['test'],
          styleBundles: ['main'],
          scriptBundles: ['utilities', 'bundle2']
        }
      ]
    }
  }
